...
<body>
	...
	<%
		...
		try {
			...
			<% out.print("Enter the customer's ID and the ticket class"); %>
			<table>
			<tr>    
			<td>Customer ID</td><td><input type="text" name="customer_ID"></td>
			</tr>
			<tr>    
			<td>Class (first or coach)</td><td><input type="text" name="class"></td>
			</tr>
			</table>
			<br><br>
			<% out.print("Enter info of the first flight to make reservations for a customer"); %>
			<table>
			<tr>    
			...
			<br><br>
			<% out.print("Enter info of the second flight to make reservations for a customer (optional)"); %>
			<table>
			<tr>    
			...
			<input type="submit" value="Make reservations"  onclick="form.action='make-reservation-for-user-2.jsp'">
			</form>
